...
const AddUser = ({ onClose, heading, item, setAdded, updateData, guest }) => {
  ...
  return (
    ...
    <div className="m-8">
      ...
      <div className="bg-black border border-white p-2 rounded-xl shadow-md px-3 md:px-8">
        ...
        <AddUserForm onClose={onClose} image={image} setImage={setImage} setAdded={setAdded} updateData={updateData} guest={guest}/>
